...
def extract_labels(basedir, labels_filename, eye_dir): ## Take dataset folder dir and label csv files as inputs
    ...
    for img in eye_paths:
        ...
        train_labels.append(eye_labels[file_name])
...
def image_processing(basedir, eye_dir):
